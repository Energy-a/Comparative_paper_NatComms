...
####### Replication code for  Fig. 1 (panel A)  and Fig. A1 (in supplementary material) ###################
...
## In addition to the global-gridded map (Fig. A1, top panel), maps are created separately for each of the following
