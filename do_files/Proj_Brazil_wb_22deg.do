...
clonevar mean_CDD_wb = mean_CDD_1970_2016 // This var has the same name in all POF waves, but CDD means are clearly computed differently in each wave					 				  

* Keep
keep stratum_groups state_code mean_CDD_wb
...
* Save	   
save "output_data_files\projections\second_stage_BRA_wb_22.dta", replace 	   
