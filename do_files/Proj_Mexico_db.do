...
keep hhid year country* state* district* weight ac ac_fut_* mean_CDD_db mean_CDD_db exp_cap_usd_2011 ln_total_exp_usd_2011 ely_q ely_hat_fut* ely_gro_* dec_inc pct_*

* Save
save "output_data_files\projections\second_stage_MEX_db.dta", replace
